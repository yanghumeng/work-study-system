<%@ Page Language="C#" AutoEventWireup="true" CodeFile="outschoolpost-list.aspx.cs" Inherits="qgzx_Manager_outschoolpost_list" %>
    ...
    <script>
        ...
        function member_stop(obj, id) {
            layer.confirm('确认要停用吗？', function (index) {
                ...
                $.ajax({
                    type: "post",
                    url: "outschoolpost-list.aspx/EditOutSchoolPostStatus",
        ...
        function member_del(obj, id) {
            layer.confirm('确认要删除吗？', function (index) {
                $.ajax({
                    type: "post",
                    url: "outschoolpost-list.aspx/Deloutschoolpost",
                    data: "{ID:'" + id + "'}",
                    contentType: "application/json;charset=utf-8",
                    dataType: "json",
                    success: function (data) {
